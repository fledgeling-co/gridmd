...
import { findPropsSplit, tryProps, splitPipeRow, parseInfoArgs, parseDocument } from '../src/parser.js';
...
test('mini document parses', () => {
  ...
  const [at1, at2, grid] = doc.sheets[0].blocks;
