...
import { resolveColor, NUMFMT_ALIASES, BUILTIN_NUMFMT_IDS } from './units.js';

const esc = (s) => String(s)
  .replaceAll('&', '&amp;').replaceAll('<', '&lt;').replaceAll('>', '&gt;')
  .replaceAll('"', '&quot;');

const BORDER_STYLES = new Map(Object.entries({
...
const PATTERNS = new Map(Object.entries({
...
export function parseBorderEdge(v, theme) {
...
export class StyleRegistry {
  ...
  alignmentXml(p) {
    const a = [];
    const H = { left: 'left', center: 'center', right: 'right', justify: 'justify', fill: 'fill', 'center-across': 'centerContinuous', distributed: 'distributed' };
    const V = { top: 'top', middle: 'center', bottom: 'bottom', justify: 'justify', distributed: 'distributed' };
