...
import { buildWorkbookModel, translateFormula } from '../src/xlsx/model.js';
import { writeXlsx } from '../src/xlsx/write.js';
import { zipWrite, zipRead, crc32 } from '../src/xlsx/zip.js';
...
test('resolveDataRef: structured refs resolve to absolute A1 ranges', () => {
  const tableIndex = new Map([['sales', {
